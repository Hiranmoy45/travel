...
export default function Testimonial() {
  ...
  // Return content for each element here
  <li key={index}>
              <div className="h-full w-full">
                {/*                    <!-- Start Testimonial --> */}
                <div className="h-full overflow-hidden rounded bg-white dark:bg-navy-900 text-slate-500 shadow-2xl shadow-slate-200 dark:shadow-navy-500">
                  <div className="relative p-6">
                    <figure className="relative z-10  ">
                      <div className="p-6 text-lg leading-relaxed dark:text-white ">
                        <p>
                          {test.text}
                        </p>
                      </div>
                      <figcaption className="flex flex-col items-start gap-2 p-6 pt-0 text-sm text-emerald-500">
                        ...
                        <div className="flex items-center gap-4 pt-4 text-sm text-emerald-500">
                          <img
                            src={`https://api.dicebear.com/5.x/initials/svg?seed=${test.name}`}
                            alt="user name"
                            title="user name"
                            width="48"
                            height="48"
                    ...
                    >
                      <path
                        ...
                        className="fill-emerald-50 dark:fill-slate-700"
                      />
                    </svg>
                  </div>
                </div>
